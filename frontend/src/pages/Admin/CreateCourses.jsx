  ...
  return (
    <AdminLayout activeSection={activeSection}>
      <section>
              ...
              return (
                <div key={stepNum} className="flex items-center">
                  ...
                  >
                    ...
                    <span className={`mt-2 text-[10px] uppercase tracking-wider font-medium hidden md:block ${
                  ...
                  {stepNum < totalSteps && (
                    <div className={`w-16 lg:w-24 h-px mx-2 transition-colors ${
        ...
        <form onSubmit={handleSubmit}>
          ...
          {currentStep === 1 && (
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg shadow-black/5 border border-black/5">
              <div className="mb-10">
                <h2 className="text-2xl font-light text-black mb-2">Información Básica</h2>
                <p className="text-sm text-gray-400 font-light">Comienza con los datos principales del curso</p>
              </div>
              ...
              <div className="mb-10">
                ...
                <input
                  ...
                  className="w-full px-6 py-5 border-2 border-black/10 rounded-xl bg-white text-black text-xl font-light placeholder-gray-300 focus:outline-none focus:border-black transition-all duration-300"
                  required
                />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-4 border border-black/10 rounded-xl bg-white text-black placeholder-gray-300 focus:outline-none focus:border-black transition font-light"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-5 py-4 border border-black/10 rounded-xl bg-white text-black focus:outline-none focus:border-black transition font-light appearance-none cursor-pointer"
                    required
                  >
                  ...
                  <div className="flex gap-3">
                    {niveles.map(nivel => (
                      <button
                        ...
                        className={`flex-1 py-4 rounded-xl text-sm font-medium transition-all duration-300 ${
          ...
          {currentStep === 2 && (
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg shadow-black/5 border border-black/5">
              <div className="mb-10">
                <h2 className="text-2xl font-light text-black mb-2">Detalles del Curso</h2>
                <p className="text-sm text-gray-400 font-light">Describe el contenido, define acceso gratis o pago y recursos del curso</p>
              </div>
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  rows="3"
                  maxLength={200}
                  className="w-full px-5 py-4 border border-black/10 rounded-xl bg-white text-black placeholder-gray-300 focus:outline-none focus:border-black transition font-light resize-none"
                  required
                />
                <p className="mt-1 text-xs text-gray-400 font-light text-right">{formData.descripcion.length}/200</p>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-start gap-6">
                  <div className="flex-1">
                    <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-black/15 rounded-xl cursor-pointer hover:border-black/30 hover:bg-black/[0.02] transition-all duration-300">
                      <svg className="w-8 h-8 text-gray-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                      <span className="text-sm text-gray-400 font-light">Haz clic para subir imagen</span>
                      <span className="text-xs text-gray-300 mt-1">PNG, JPG hasta 5MB</span>
                      <input type="file" accept="image/*" onChange={handleImageChange} className="hidden" />
                    </label>
                  </div>
                  {previewImage && (
                    <div className="relative w-40 h-40 rounded-xl overflow-hidden border border-black/10">
                      <img src={previewImage} alt="Preview" className="w-full h-full object-cover" />
                      <button
                        type="button"
                        onClick={() => { setPreviewImage(null); setFormData({ ...formData, imagenPortada: null }) }}
                        className="absolute top-2 right-2 w-6 h-6 bg-black/70 text-white rounded-full flex items-center justify-center text-xs hover:bg-black transition"
                      >
                        ✕
                      </button>
                    </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 font-light">$</span>
                    <input
                      type="number"
                      name="precio"
                      ...
                      className="w-full pl-10 pr-5 py-4 border border-black/10 rounded-xl bg-white text-black placeholder-gray-300 focus:outline-none focus:border-black transition font-light disabled:bg-gray-100 disabled:text-gray-400"
          ...
          {submitStatus && (
            <div className={`mt-6 p-5 rounded-xl border flex items-start gap-3 ${
              ...
              <div>
                ...
                {submitStatus === 'success' && (
                  <p className="text-xs mt-1 opacity-70">La lista de tus cursos fue actualizada.</p>
                )}
              </div>
            </div>
          )}
          ...
          <div className="flex items-center justify-between mt-8">
            <button
              type="button"
              onClick={prevStep}
              className={`px-8 py-4 border border-black/20 text-black text-xs uppercase tracking-wider font-medium rounded-xl hover:bg-black hover:text-white transition-all duration-300 ${
            ...
            {currentStep < totalSteps ? (
              <button
                ...
                className={`px-8 py-4 bg-black text-white text-xs uppercase tracking-wider font-medium rounded-xl transition-all duration-300 shadow-lg shadow-black/10 ${
              ...
              <button
                ...
                className={`px-10 py-4 bg-black text-white text-xs uppercase tracking-wider font-medium rounded-xl transition-all duration-300 shadow-lg shadow-black/10 flex items-center gap-2 ${
        ...
        <div className="mt-14 bg-white rounded-2xl p-8 md:p-10 shadow-lg shadow-black/5 border border-black/5">
          <div className="flex items-center justify-between gap-4 mb-6">
            <div>
              <h2 className="text-2xl font-light text-black">Tus Cursos Creados</h2>
              <p className="text-sm text-gray-500">Solo tú puedes editar, desactivar o eliminar los cursos que creaste.</p>
            </div>
            <button
              type="button"
              onClick={loadMyCourses}
              className="px-4 py-2 border border-black/20 rounded-xl text-xs uppercase tracking-wider hover:bg-black hover:text-white transition"
            >
              Recargar
            </button>
          </div>
          ...
          <div className="mb-6 flex flex-wrap items-center gap-2">
            {[
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-xs uppercase tracking-wider border transition ${
          ...
          {loadingMyCourses ? (
            ...
            <p className="text-sm text-gray-500">Aún no has creado cursos.</p>
          ) : (
            <div className="space-y-4">
              {paginatedMyCourses.map((course) => (
                <article key={course.id} className="rounded-xl border border-black/10 p-5 bg-white">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                      <h3 className="text-lg font-medium text-black">{course.titulo}</h3>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Suscritos: {course.estudiantes || 0}</p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        ...
                        className="px-4 py-2 rounded-lg border border-black/20 text-xs uppercase tracking-wider hover:bg-black hover:text-white transition disabled:opacity-50"
                      >
                        Editar
                      </button>
                      <button
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-lg border border-red-300 text-red-600 text-xs uppercase tracking-wider hover:bg-red-600 hover:text-white transition disabled:opacity-50"
                      >
                        Eliminar
                      </button>
                      <button
                  ...
                  {Array.isArray(subscribersByCourse[course.id]) && (
                    <div className="mt-4 border-t border-black/10 pt-4">
                      <p className="text-xs uppercase tracking-wider text-gray-500 mb-2">Suscriptores registrados</p>
                      {subscribersByCourse[course.id].length === 0 ? (
                        <p className="text-sm text-gray-500">Aún no hay suscripciones en este curso.</p>
                      ) : (
                        <div className="space-y-2">
                          {subscribersByCourse[course.id].map((subscriber) => (
                            <div key={`${course.id}-${subscriber.uid}`} className="flex items-center justify-between text-sm bg-black/[0.02] rounded-lg px-3 py-2">
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-3 py-2 rounded-lg border border-black/20 text-xs uppercase tracking-wider hover:bg-black hover:text-white transition disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                      Anterior
                    </button>
                    <button
