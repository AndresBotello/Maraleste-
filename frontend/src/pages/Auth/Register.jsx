      ...
      <header className="auth-header border-b border-black/5 sticky top-0 bg-white/70 backdrop-blur-xl z-50">
        <div className="auth-shell max-w-7xl mx-auto px-6 lg:px-12 py-5 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-[11px] uppercase tracking-[0.4em] font-medium">
            ...
            <Link to="/login" className="auth-link text-black hover:underline underline-offset-4">Iniciar sesión</Link>
          </div>
          <button
            type="button"
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-black/5 bg-white/90 px-6 py-6 space-y-6 text-[11px] uppercase tracking-[0.3em] text-gray-600">
            ...
            <Link to="/login" className="auth-link block hover:text-black transition" onClick={() => setMenuOpen(false)}>Iniciar sesión</Link>
          </div>
        )}
      </header>
          ...
          <div className="space-y-12">
            <header className="space-y-6">
              ...
              <div className="grid gap-6 sm:grid-cols-3">
                <article className="auth-stat rounded-2xl border border-black/10 bg-white/70 backdrop-blur-sm px-5 py-6">
          ...
          <div className="w-full">
            <div className="auth-panel rounded-3xl border border-black/10 bg-white/80 backdrop-blur-xl p-8 lg:p-10 shadow-xl shadow-black/10">
              <div className="text-center mb-10">
                <h2 className="auth-section-title text-3xl font-light text-black mb-4">Crear cuenta</h2>
                <p className="auth-muted text-sm text-gray-500">Regístrate para comenzar tu recorrido. Podrás editar tus datos más adelante.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <div>
                    <label htmlFor="firstName" className="auth-label block text-[11px] uppercase tracking-[0.3em] text-gray-500 font-semibold mb-3">
                      Nombre
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="lastName" className="auth-label block text-[11px] uppercase tracking-[0.3em] text-gray-500 font-semibold mb-3">
                      Apellido
                    </label>
                    <input
                      type="text"
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  ...
                  <div>
                    <label htmlFor="confirmPassword" className="auth-label block text-[11px] uppercase tracking-[0.3em] text-gray-500 font-semibold mb-3">
                      Confirmar
                    </label>
                    <div className="relative">
                      <input
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="auth-btn auth-btn--solid w-full h-12 rounded-xl bg-black text-white text-[11px] uppercase tracking-[0.3em] font-medium hover:bg-gray-900 transition shadow-lg shadow-black/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <div className="flex items-center gap-4 my-8">
                <div className="auth-divider flex-1 h-px bg-black/10" />
              ...
              <div className="mt-10 text-center text-xs text-gray-500">
                <p>
                  ...
                  <a href="/login" className="auth-link font-medium text-black hover:underline underline-offset-4">
                    Inicia sesión aquí
                  </a>
                </p>
              </div>
